...
function SockeManage:loadMsgDef()
	_WG = _WG or {}
	_WG.error = _WG.error or self.__ErrorBackHandle
	_WG.Instance = _WG.Instance or {}
	_WG.Instance.tools = require("tools")
	local msg = require("MsgDef.MsgDef")
	msg:setSendFunc(function (tData,tid)
		return self:send(tData,tid)
	end)
	--....
end
